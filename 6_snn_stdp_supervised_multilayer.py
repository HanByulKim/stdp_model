...
class NN:
    def __init__(self, size, N, Wmax, Wmin, Vth, ALTP, ALTD, tau_ltp, tau_ltd, aLTP, aLTD, inTarget, deTarget):
        self.size = size
        self.N = N
...
layer1 = NN(size*size, middle_layer, Wmax, Wmin, Vth, ALTP, ALTD, tau_ltp, tau_ltd, aLTP, aLTD, inTarget, deTarget)
layer2 = NN(middle_layer, N, Wmax, Wmin, Vth, ALTP, ALTD, tau_ltp, tau_ltd, aLTP, aLTD, inTarget, deTarget)
neuron_post = layer2.post_size
neuron_inTarget = layer2.inTarget
neuron_deTarget = layer2.deTarget
#%%
# Train
i=0
while(i < train_size):
    ...
    out = layer2.Wmul(layer1.Wmul(sampling))
    file2.write(str(out))
